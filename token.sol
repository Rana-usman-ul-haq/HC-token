...
contract HOGOC is Context, IERC20, Ownable {
    ...
    string private _name = "HOGOC";
    string private _symbol = "HOGOC";
    ...
    address payable public marketingWallet = payable(0x530071d81E2E7467de1C06984E1545bc9B920c00); //Update marketing Wallet
    ...
    function setFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(liquidityFee.add(marketingFee).add(burnFee) <= 10, "tax too high");
